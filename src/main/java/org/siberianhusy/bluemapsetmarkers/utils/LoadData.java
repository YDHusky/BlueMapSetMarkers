...
public class LoadData {
    ...
    public static void savePlayerData(){
        BlueMapSetMarkers.bmsm.saveResource("Data/data.yml",true);
        File dataFile = new File(BlueMapSetMarkers.bmsm.getDataFolder(), "Data/data.yml");
    ...
    public static void reloadConfig(){
        BlueMapSetMarkers.bmsm.reloadConfig();
        File messagesFile = new File(BlueMapSetMarkers.bmsm.getDataFolder(), "Messages/messages.yml");
    ...
    public static void saveWorldMarkerSet(World world) {
        ...
        File file = new File(BlueMapSetMarkers.bmsm.getDataFolder(), name);
    ...
    private static void createFile(String data) {
        File dataFile = new File(BlueMapSetMarkers.bmsm.getDataFolder(), data);
        try {
            //当文件夹中不存在时创建文件
            File folder = BlueMapSetMarkers.bmsm.getDataFolder();
